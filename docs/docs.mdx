...
<Button
  component="a"
  href={`${process.env.NEXT_PUBLIC_BASE_PATH || ''}/responsive`}
  target="_blank"
  rightSection={
    <IconExternalLink
      style={{ width: rem(18), height: rem(18) }}
...
<Table striped highlightOnHover withTableBorder withColumnBorders>
  ...
  <Table.Tbody>
    ...
    <Table.Tr>
      ...
      <Table.Td>
        Border radius of the cutout. Use <Code>9999</Code> for
        circular elements.
      </Table.Td>
    </Table.Tr>
  </Table.Tbody>
